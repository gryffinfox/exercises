...
while True:
    ...
    while True:
        try:
            players_guess = int(input('I am thinking of a number between 1 and 9. Can you guess it? '))
            break
        except ValueError:
    ...
    if generated_number == players_guess:
        ...
        print('No, you guessed a number that was smaller than the one I had on my mind.')
    elif generated_number < players_guess:
